  ...
  const LIST = [
    {
      ...
      hp: 5000, life: 5,
      abilityName: '烈焰冲锋',
      abilityDescription: '攻势港群：麾下 23 员战将均费 4.1、最高战力 9000，突袭×4 全场最多抢血，反击牌×12 张网。',
      flavorText: '风暴越大，船头指向越不变。',
      cardNumber: 'OP-01 LDR/001', isUnlocked: true,
    },
    {
      id: 'ace', color: 'red', leaderId: 'LEADER-RED2', rarity: 'legendary',
      name: '波特卡斯·D·艾斯', title: '火拳',
      image: 'art/captains/ace.webp', imagePosition: 'center 8%',
      faction: FACTION.red.name, factionColor: FACTION.red.color, accentColor: FACTION.red.accent,
      hp: 4000, life: 5,
      abilityName: '火拳',
      abilityDescription: '船长攻击宣告时战力 +2000——血量 4K 全场最薄，换来的是最凶的船长拳。',
      flavorText: '他从不回头，火焰也从不。',
      cardNumber: 'OP-02 LDR/007', isUnlocked: true,
    },
    {
      ...
      hp: 4500, life: 5,
      abilityName: '剑冢坚壁',
      abilityDescription: '重装港群：均费 4.5 全场最重、厚积薄发，高费角色登场永久 +1K，突袭×2 一击定胜负。',
      flavorText: '败北二字，不在他的刀谱里。',
      cardNumber: 'OP-01 LDR/002', isUnlocked: true,
    },
    {
      id: 'kaido', color: 'green', leaderId: 'LEADER-GREEN2', rarity: 'legendary',
      name: '凯多', title: '百兽海贼团总督',
      image: 'art/captains/kaido.webp', imagePosition: 'center 10%',
      faction: FACTION.green.name, factionColor: FACTION.green.color, accentColor: FACTION.green.accent,
      hp: 6000, life: 5,
      abilityName: '最强生物',
      abilityDescription: '费用 ≥5 的角色登场永久 +2000——高费大怪越养越凶，后期怪物房。',
      flavorText: '单挑，他从未败过。',
      cardNumber: 'OP-02 LDR/008', isUnlocked: true,
    },
    {
      ...
      hp: 5500, life: 5,
      abilityName: '雷舵千帆',
      abilityDescription: '防守反击：反击牌×15 全场最多，均费 3.9 全场最轻灵，以逸待劳耗沉对手。',
      flavorText: '她画的航图，比罗盘更早预知风雨。',
      cardNumber: 'OP-01 LDR/003', isUnlocked: true,
    },
    {
      id: 'robin', color: 'blue', leaderId: 'LEADER-BLUE2', rarity: 'epic',
      name: '妮可·罗宾', title: '恶魔之子',
      image: 'art/captains/robin.webp', imagePosition: 'center 12%',
      faction: FACTION.blue.name, factionColor: FACTION.blue.color, accentColor: FACTION.blue.accent,
      hp: 5000, life: 5,
      abilityName: '百花缭乱',
      abilityDescription: '费用 ≥4 的角色登场就抽 1 张——中高费连登不断补牌，历史学者的情报网。',
      flavorText: '她想读的，是那段被抹去的历史。',
      cardNumber: 'OP-02 LDR/009', isUnlocked: true,
    },
    {
      ...
      hp: 5000, life: 5,
      abilityName: '疾风铁壁',
      abilityDescription: '铁壁港群：格挡×7 全场最多，均费 4.0 进退有度，密不透风的机动防线。',
      flavorText: '火候与拳速，出自同一种温柔。',
      cardNumber: 'OP-01 LDR/004', isUnlocked: true,
    },
    {
      id: 'hancock', color: 'yellow', leaderId: 'LEADER-YELLOW2', rarity: 'epic',
      name: '波雅·汉库珂', title: '海盗女帝',
      image: 'art/captains/hancock.webp', imagePosition: 'center 6%',
      faction: FACTION.yellow.name, factionColor: FACTION.yellow.color, accentColor: FACTION.yellow.accent,
      hp: 5000, life: 5,
      abilityName: '甜美之惠',
      abilityDescription: '己方角色被击沉时回复 2000 积分——比山治回血翻倍，打不穿的傲慢。',
      flavorText: '被她的视线注视，都会化为石头。',
      cardNumber: 'OP-02 LDR/010', isUnlocked: true,
    },
    {
      ...
      hp: 6000, life: 5,
      abilityName: '雷刃手术',
      abilityDescription: '控制港群：均费 4.2，船长击沉对方角色即抽牌，精准拆解对手节奏，落刀之前局已布完。',
      flavorText: '手术刀落下之前，局已布完。',
      cardNumber: 'OP-01 LDR/005', isUnlocked: true,
    },
    {
      id: 'doflamingo', color: 'purple', leaderId: 'LEADER-PURPLE2', rarity: 'epic',
      name: '唐吉诃德·多弗朗明戈', title: '天夜叉',
      image: 'art/captains/doflamingo.webp', imagePosition: 'center 8%',
      faction: FACTION.purple.name, factionColor: FACTION.purple.color, accentColor: FACTION.purple.accent,
      hp: 4500, life: 5,
      abilityName: '天夜叉的情报网',
      abilityDescription: '每回合开始抽 1 张牌——资源永不断档，代价是 4.5K 血量与牌库抽空风险。',
      flavorText: '德雷斯罗萨的线，牵在他指尖。',
      cardNumber: 'OP-02 LDR/011', isUnlocked: true,
    },
    {
      ...
      hp: 5000, life: 5,
      abilityName: '霸王月涛',
      abilityDescription: '霸主港群：麾下最高 8000，均费 4.3 高压强攻，猛击×1 直取要害，格挡×3 攻守兼备。',
      flavorText: '他抬眼的一瞬，海面先安静了。',
      cardNumber: 'OP-01 LDR/006', isUnlocked: true,
    },
    {
      id: 'mihawk', color: 'black', leaderId: 'LEADER-BLACK2', rarity: 'epic',
      name: '乔拉可尔·米霍克', title: '鹰眼',
      image: 'art/captains/mihawk.webp', imagePosition: 'center 12%',
      faction: FACTION.black.name, factionColor: FACTION.black.color, accentColor: FACTION.black.accent,
      hp: 4500, life: 5,
      abilityName: '世界最强剑士',
      abilityDescription: '船长攻击宣告时战力 +2000——黑刀一闪 6.5K，血量 4.5K 换最强一击。',
      flavorText: '你的刀，还够不着他。',
      cardNumber: 'OP-02 LDR/012', isUnlocked: true,
    },
  ];
