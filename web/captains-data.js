  ...
  const LIST = [
    {
      ...
      hp: 5000, life: 5,
      abilityName: '烈焰冲锋',
      abilityDescription: '攻势港群：麾下 10 员战将均费 3.5、最高战力 8000，突袭×2 抢血，反击×5 张网。',
    ...
    },
    {
      ...
      hp: 5000, life: 5,
      abilityName: '剑冢坚壁',
      abilityDescription: '重装港群：最高战力 9000 冠绝六色，均费 4.9 厚积薄发，突袭×2 一击定胜负。',
    ...
    },
    {
      ...
      hp: 5000, life: 4,
      abilityName: '雷舵千帆',
      abilityDescription: '防守反击：千金反击×6 全场最多，均费 3.4 轻灵机动，以逸待劳耗沉对手。',
    ...
    },
    {
      ...
      hp: 5000, life: 5,
      abilityName: '疾风铁壁',
      abilityDescription: '铁壁港群：格挡×4 全场最多，均费 3.9 进退有度，密不透风的机动防线。',
    ...
    },
    {
      ...
      hp: 5000, life: 5,
      abilityName: '雷刃手术',
      abilityDescription: '控制港群：均费 3.7、千金反击×5，精准拆解对手节奏，落刀之前局已布完。',
    ...
    },
    {
      ...
      hp: 5000, life: 4,
      abilityName: '霸王月涛',
      abilityDescription: '霸主港群：麾下最高 8000，均费 4.6 高压强攻，斩杀×3 精准拆解，格挡×2 攻守兼备。',
