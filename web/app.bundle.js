...
const POOL = {
  "meta": {
    ...
    "pack": "OP-02 追加：6 新船长 + 30 新卡（2026-09-19）"
  },
  "leaders": [
    {
      "id": "LEADER-RED",
    ...
    },
    {
      ...
      "art": "captains/robin",
      "skill": "百花缭乱",
      "skillDesc": "费用 ≥4 的己方角色登场时，抽 1 张牌",
      "effect": {
        "hook": "onSummon",
        "op": {
          "k": "draw",
    ...
    },
    {
      ...
      "art": "captains/kaido",
      "skill": "最强生物",
      "skillDesc": "费用 ≥5 的角色登场时，该角色永久 +2000",
      "effect": {
        "hook": "onSummon",
        "op": {
          "k": "powerSelf",
    ...
    },
    {
      ...
      "skill": "甜美之惠",
      "skillDesc": "己方角色被击沉时，回复 2000 积分（不超过上限）",
      "effect": {
        "hook": "onAllyKO",
        "op": {
          "k": "healLP",
